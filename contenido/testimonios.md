# Testimonios de miembros del club

Recopilación de testimonios para el proyecto del sitio del Club de Montaña Collipulli.
Los textos se guardan tal como los entregaron sus autores.
Las fotos están en `fotos-testimonios/`, nombradas con el nombre de cada persona.
...
- Autorización para publicar: sí, confirmada por Carlos Aburto el 2026-08-27
- Nota: es el más extenso; si va en la portada quizá convenga una versión corta.
